                        ...
                        <form action="#" method="post">
                            <div class="group__flex">
                                <div class="input__group">
                                    ...
                                    <input type="text" name="" id="" value="Emrecan Ünlü">
                                </div>
                                <div class="input__group">
                                    <label for="">E-Mail</label>
                                    <input type="text" name="" id="" value="unl.c.emre@gmail.com" disabled>
                                </div>
                            </div>
                        ...
                        <form action="#" method="post">
                            <div class="group__flex">
                                ...
                                <div class="input__group">
                                    ...
                                    <input type="text" name="" id="" placeholder="Yeni Şifreniz">
                                </div>
                            </div>
