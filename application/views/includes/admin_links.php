...
<link href="<?=base_url('admin/vendor/datatables/datatables.min.css');?>" rel="stylesheet">
<link href="<?=base_url('admin/css/master.css')?>" rel="stylesheet">
<link href="<?=base_url('admin/vendor/flagiconcss/css/flag-icon.min.css')?>" rel="stylesheet">